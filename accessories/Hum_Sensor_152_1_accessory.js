...
var MQTT_TOPIC = 'hum1'; //MQTT topic that was set on the Sonoff firmware
var debug = 0;
...
var sensorUUID = uuid.generate('hap-nodejs:accessories:hum152_1');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake lock.
var sensor = exports.accessory = new Accessory('Hum152_1', sensorUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
sensor.username = "D2:5D:Z1:AE:5E:F1";
...
sensor
  ...
  .setCharacteristic(Characteristic.Model, "DHT22_152_1") //additional  accessory information
  .setCharacteristic(Characteristic.SerialNumber, "000100"); //additional  accessory information

// Add the actual TemperatureSensor Service.
// We can see the complete list of Services and Characteristics in `lib/gen/HomeKitTypes.js`
sensor
   .addService(Service.HumiditySensor, "Hum152_1")
