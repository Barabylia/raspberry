...
var MQTT_TOPIC = 'mytemp1'; //MQTT topic that was set on the Sonoff firmware
var debug = 0;
...
var sensorUUID = uuid.generate('hap-nodejs:accessories:temp152_1');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake lock.
var sensor = exports.accessory = new Accessory('Temp1', sensorUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
sensor.username = "Z1:5D:3A:AE:5E:FA";
...
sensor
  ...
  .setCharacteristic(Characteristic.Model, "DHT22_152_1 sensor") //additional  accessory information
  .setCharacteristic(Characteristic.SerialNumber, "000001"); //additional  accessory information

// Add the actual TemperatureSensor Service.
// We can see the complete list of Services and Characteristics in `lib/gen/HomeKitTypes.js`
sensor
  .addService(Service.TemperatureSensor, "Temp1")
